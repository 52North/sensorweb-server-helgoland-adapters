...
public final class EntityBuilder {
    ...
    public static ProcedureEntity createProcedure(String identifier, String name,
    ...
    public static FeatureEntity createFeature(String identifier, String name, String description, GeometryEntity geometry,
            ServiceEntity service) {
