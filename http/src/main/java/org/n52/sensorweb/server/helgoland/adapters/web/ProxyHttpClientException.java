...
public class ProxyHttpClientException extends LocationHintException {
    ...
    public ProxyHttpClientException(String message) {
        super(message);
    }

    public ProxyHttpClientException(String message, Object... args) {
        super(message, args);
    }

    public final ProxyHttpClientException causedBy(final Throwable exception) {
        return (ProxyHttpClientException) initCause(exception);
    }
