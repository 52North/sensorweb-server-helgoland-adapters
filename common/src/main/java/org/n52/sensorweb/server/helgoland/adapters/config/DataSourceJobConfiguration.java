...
public class DataSourceJobConfiguration {
    ...
    private String fullCronExpression;
    private String temporalCronExpression;
    ...
    public String getTemporalCronExpression() {
        return temporalCronExpression;
    }

    public void setTemporalCronExpression(String temporalCronExpression) {
        this.temporalCronExpression = temporalCronExpression;
    }
    ...
    public JobConfiguration getFullJobConfiguration() {
        return new JobConfiguration().setEnabled(isEnabled()).setTriggerAtStartup(isTriggerAtStartup())
                .setCronExpression(getFullCronExpression());
    }

    public JobConfiguration getTemporalJobConfiguration() {
        return new JobConfiguration().setEnabled(isEnabled()).setTriggerAtStartup(false)
                .setCronExpression(getTemporalCronExpression());
    }
