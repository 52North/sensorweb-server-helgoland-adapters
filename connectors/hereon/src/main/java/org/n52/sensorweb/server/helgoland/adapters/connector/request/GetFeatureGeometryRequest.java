...
public class GetFeatureGeometryRequest extends AbstractDataHereonRequest
        implements HereonConstants, ResponseClass<ExtentResponse> {

    public GetFeatureGeometryRequest() {
        super();
    }
