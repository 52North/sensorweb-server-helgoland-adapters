...
public abstract class AbstractSosConnector extends AbstractServiceConnector {
    ...
    protected GetFeatureOfInterestResponse getFeatureOfInterest(String featureId, String procedureId, String obsProp,
        ...
        try {
            if (supportsKvp(config)) {
                ...
                SoapRequest soap = new SoapRequest(SoapConstants.NS_SOAP_12, SoapConstants.SOAP_1_2_VERSION);
    ...
    protected boolean supportsGDA(OwsCapabilities owsCaps) {
        return owsCaps.getServiceIdentification().isPresent()
                && owsCaps.getServiceIdentification().get().getProfiles()
                        .contains(URI.create(GetDataAvailabilityConstants.CONFORMANCE_CLASS))
